...
public final class TaskFactory {
    ...
    public synchronized Task getTask(String taskName) {
        ...
        if (task == null) {
            throw new IllegalArgumentException("Create task fail, " +
                    "there is no task corresponding to the task name. " +
                    "Make sure you have create a task instance in TaskCreator.");
        }
