...
class ConfigParser {
    ...
    private static class TaskBundle {
        ...
        TaskBundle(int mode, String processName, List<TaskInfo> tasks) {
            this.mode = mode;
    ...
    private static class TaskInfo {
        ...
        int executePriority = Task.DEFAULT_EXECUTE_PRIORITY;

        TaskInfo(String id, String path) {
            this.id = id;
            this.path = path;
        }
    ...
    public static class ProjectInfo {
        ...
        ProjectInfo(Task project, int mode, String processName) {
